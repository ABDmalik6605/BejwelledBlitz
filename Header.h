...
void myLine1(int x1, int y1, int x2, int y2, int color1,int color2,int color3) //use three 3 integers if you want colored lines.
{
	HWND console_handle = GetConsoleWindow();
	HDC device_context = GetDC(console_handle);
...
bool isCursorKeyPressed0(int& whichKey)   //whichKey passed as reference.... 
{
	char key;
...
void specialRectangle(int x1, int y1, int x2, int y2, int R, int G, int B)
{
	HWND console_handle = GetConsoleWindow();
	HDC device_context = GetDC(console_handle);
